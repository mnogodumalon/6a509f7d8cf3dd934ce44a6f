// Auto-generated. Per-entity form-enhancements config for "Mängelverwaltung".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [
    ...
    'beschreibung',
    'dringlichkeit',
    { row: ['melder_vorname', 'melder_nachname'] },
    'meldedatum',
    'handwerker',
    'status',
  ],
  defaults: {
    ...
    dringlichkeit: { kind: 'lookup', key: 'mittel', label: 'Mittel' },
